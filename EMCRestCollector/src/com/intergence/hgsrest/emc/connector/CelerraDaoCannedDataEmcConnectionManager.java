...
/**
 * Provides canned data responses to the EmcConnectorManager for integration testing.
 * **Not used for production**
 *
 *
 * @author stephen
 */
public class CelerraDaoCannedDataEmcConnectionManager implements EmcConnectorManager {
	...
	public String makeCall(String request) throws RuntimeException {
        log.warn("Using canned data - not for production");

		if (request.contains("CelerraSystemQueryParams")) {
			return GET_SYSTEM_INFO_RESPONSE;
		}
		else if (request.contains("ClariionGeneralConfigQueryParams")) {
			return GET_GENERAL_CONFIG_RESPONSE;
		}
		else if (request.contains("ControlStationQueryParams")) {
			return GET_CONTROL_STATION_RESPONSE;
		}
		else if (request.contains("ClariionDiskQueryParams")) {
			return GET_ALL_DISK_INFO_RESPONSE;
		}
		else if (request.contains("ClariionRaidGroupQueryParams")) {
			return GET_ALL_RAID_GROUP_RESPONSE;
		}
		else if (request.contains("ClariionSpQueryParams")) {
			return GET_ALL_STORAGE_PROCESSOR_RESPONSE;
		}

		return null;
	}

	private static final String GET_SYSTEM_INFO_RESPONSE =
	...
	private static final String GET_GENERAL_CONFIG_RESPONSE =
	...
	private static final String GET_CONTROL_STATION_RESPONSE =
			"<ResponsePacket xmlns=\"http://www.emc.com/schemas/celerra/xml_api\">\n" +
			"    <Response>\n" +
			"        <QueryStatus maxSeverity=\"ok\"/>\n" +
	...
	private static final String GET_ALL_DISK_INFO_RESPONSE = "<ResponsePacket xmlns=\"http://www.emc.com/schemas/celerra/xml_api\" apiVersion=\"V1_1\">\n"+
			"    <ResponseEx>\n"+
	...
	private static final String GET_ALL_RAID_GROUP_RESPONSE =
	...
	private static final String GET_ALL_STORAGE_PROCESSOR_RESPONSE =
			"<ResponsePacket xmlns=\"http://www.emc.com/schemas/celerra/xml_api\" apiVersion=\"V1_1\">\n" +
					"    <ResponseEx>\n" +
